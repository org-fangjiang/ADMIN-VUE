...
export const _LayoutConst = {
  ...
  _RULES: {
    room: [{ required: true, message: t('host.layout.room'), trigger: 'blur' }],
    hall: [{ required: true, message: t('host.layout.hall'), trigger: 'blur' }],
    toilet: [{ required: true, message: t('host.layout.toilet'), trigger: 'blur' }],
    area: [{ required: true, message: t('host.layout.area'), trigger: 'blur' }],
