  ...
  <div :class="prefixCls">
    ...
    >
      <FormItem ref="name" :label="t('host.name')" name="name">
        <Input
          :disabled="!estateCompanyConst._UPDATE_FIELDS.includes('name')"
      ...
      <FormItem ref="description" :label="t('host.description')" name="description">
        <Textarea
          :disabled="!estateCompanyConst._UPDATE_FIELDS.includes('description')"
      ...
      <FormItem ref="link" :label="t('host.link')" name="link">
        <Input
          :disabled="!estateCompanyConst._UPDATE_FIELDS.includes('link')"
