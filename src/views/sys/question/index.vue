...
<template>
  <div :class="prefixCls" class="relative w-full h-full px-4">
    <Button v-auth="questionConst._PERMS.EXAMINE" @click="mulPass" :class="`${prefixCls}-select`">
      {{ t('model.question.pass') }}
    </Button>
    <Button v-auth="questionConst._PERMS.EXAMINE" @click="mulFail" :class="`${prefixCls}-select`">
...
<script lang="ts">
  ...
  import { examine, pass, failedOne, passIds, failedIds } from '/@/api/host/question/question';
  import {
    _QuestionConst,
    QuestionModel,
