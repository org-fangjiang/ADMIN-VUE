...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      //验证规则
      const rules = reactive(PrivateConst._RULES);
      ...
      return {
        ...
        labelCol: { span: 6 },
        wrapperCol: { span: 12 },
        updateFields: PrivateConst._UPDATE_FIELDS,
        liveInChange,
        workInChange,
        changeProvince,
        changeCity,
