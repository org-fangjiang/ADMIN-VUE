...
<script lang="ts">
  ...
  import { CityConst, CityModel } from '/@/api/customer/crmCity/model/CityModel';
  import { addCity, getCityById, inSystem } from '/@/api/customer/crmCity/city';
